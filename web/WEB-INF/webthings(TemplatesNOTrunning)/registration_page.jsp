...
<form action="/Registration" id="form" method="post">
    ...
    <input type="date" id="date" name="date"
           value="${profileInfo.date}"> <%--THIS   DOES NOT WORK IN IE IE DONT USE IE--%>
...
<script type="text/javascript">
    <%--This script checks on submission whether the form is empty or contains spaces, if so fails the submit--%>
